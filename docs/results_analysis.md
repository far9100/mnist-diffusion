...
oracle。C0 recall/density 探針（`records/2026-07-09-12`）測得 recall 可打破 w2.5 的支配、density 不能。
故 D 包（`records/2026-07-09-13`，作者終簽）將 plan-of-record selector 改為 **CaF-v2 =
